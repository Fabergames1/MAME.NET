        ...
        private static void cps1_render_layer(int layer)
        {
            switch (layer)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ttmap[0].tilemap_draw_primask(Video.screenstate.visarea, 0x20, 0);
                    break;
                case 2:
                    ttmap[1].tilemap_draw_primask(Video.screenstate.visarea, 0x20, 0);
                    break;
                case 3:
                    ttmap[2].tilemap_draw_primask(Video.screenstate.visarea, 0x20, 0);
                    break;
            }
        }
