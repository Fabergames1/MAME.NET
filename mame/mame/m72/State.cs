...
namespace mame
{
    public partial class M72
    {
        public static void SaveStateBinary(BinaryWriter writer)
        {
            ...
            writer.Write(Video.scanline_param);
            writer.Write(Video.screenstate.last_partial_scan);
        ...
        public static void LoadStateBinary(BinaryReader reader)
        {
            ...
            Video.scanline_param = reader.ReadInt32();
            Video.screenstate.last_partial_scan = reader.ReadInt32();
