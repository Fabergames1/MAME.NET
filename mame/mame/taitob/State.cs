...
namespace mame
{
    public partial class Taitob
    {
        public static void SaveStateBinary(BinaryWriter writer)
        {
            ...
            AY8910.SaveStateBinary(writer);
            YM2610.SaveStateBinary(writer);
            for (i = 0; i < 2; i++)
            {
            ...
            writer.Write(Sound.ay8910stream.gain);
        ...
        public static void LoadStateBinary(BinaryReader reader)
        {
            ...
            AY8910.LoadStateBinary(reader);
            YM2610.LoadStateBinary(reader);
            for (i = 0; i < 2; i++)
            {
            ...
            Sound.ay8910stream.gain = reader.ReadInt32();
