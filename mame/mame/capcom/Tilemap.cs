...
namespace mame
{
    public partial class Capcom
    {
        public static void tilemap_init()
        {
            ...
            bg_tilemap.tilemap_draw_instance3 = bg_tilemap.tilemap_draw_instanceCapcom;
            ...
            fg_tilemap.tilemap_draw_instance3 = fg_tilemap.tilemap_draw_instanceCapcom;
            ...
            tx_tilemap.tilemap_draw_instance3 = tx_tilemap.tilemap_draw_instanceCapcom;
    ...
    {
        public void tilemap_draw_instanceCapcom(RECT cliprect, int xpos, int ypos)
        {
            int mincol, maxcol;
            int x1, y1, x2, y2;
            int y, nexty;
